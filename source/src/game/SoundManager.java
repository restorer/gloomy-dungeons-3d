...
public class SoundManager
{
	...
	public static PlayList LIST_MAIN = new PlayList(new String[] { "1", "2", "3", "4" });
	public static PlayList LIST_ENDL = new PlayList(new String[] { "endl" });
	public static PlayList LIST_GAMEOVER = new PlayList(new String[] { "gameover" });
	...
	private static void updateVolume()
	{
		...
		musicVolume = (float)sp.getInt("MusicVolume", 5) / 10.0f;		// 0 .. 1.0
	...
	private static void play(boolean wasPlaying)
	{
		...
		try
		{
			AssetFileDescriptor afd = assetManager.openFd("music/" + current.list[current.idx] + ".mid");
