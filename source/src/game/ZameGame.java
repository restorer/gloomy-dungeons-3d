...
public abstract class ZameGame implements GLSurfaceView.Renderer
{
	...
	public void onSurfaceChanged(GL10 gl, int width, int height)
	{
		...
		this.width = (width < 1 ? 1 : width);		// just for case
		this.height = (height < 1 ? 1 : height);	// just for case
	...
	public void setUpdateInterval(long updateInterval)
	{
		synchronized (lockUpdate) {
			this.updateInterval = (updateInterval > 1 ? updateInterval : 1);
		}
	}
